...
contract MockBeraReserveBondDepository is Ownable {
    ...
    function deposit(uint256 _amount, uint256 _maxPrice, address _depositor) external returns (uint256) {
        ...
        require(payout >= 10000000, "Bond too small"); // must be > 0.01 BRR ( underflow protection )
    ...
    function maxPayout() public view returns (uint256) {
        return IERC20(BRR).totalSupply().mul(terms.maxPayout).div(100000);
    }
